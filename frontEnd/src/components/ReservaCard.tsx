...
export default function BookingCard({ booking, onDelete }: { booking: ReservaFromDB, onDelete: (bookingId: number) => void }) {
  return (
    <Card className="overflow-hidden">
      ...
      <CardFooter>
        <Button className="w-full" onClick={() => onDelete(booking.id)}>
          Cancelar
        </Button>
      </CardFooter>
    </Card>
